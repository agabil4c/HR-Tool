...
const EmployeeWork = ({ records = [] }) => {
  const [localRecords] = useState([{
    date: '13 Oct, 2023',
    day: 'Fri',
    checkIn: '08:23 AM',
    checkOut: '07:00 PM',
  ...
  const displayedRecords = records.length > 0 ? records : localRecords;
      ...
      <div className="flex flex-col">
            ...
            <div className="overflow-hidden">
              <table className="min-w-full divide-y divide-default-200">
                ...
                <tbody className="divide-y divide-default-200">
                  {displayedRecords.map((record, index) => <tr key={index} className="text-default-800 font-normal whitespace-nowrap">
        ...
        <div className="card-footer">
          <p className="text-default-500 text-sm">
            Showing <b>{displayedRecords.length}</b> of <b>15</b> Results
          </p>
